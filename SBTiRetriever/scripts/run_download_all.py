...
def main() -> None:
    parser = argparse.ArgumentParser(description="Télécharger tous les documents SBTi dont le score dépasse un seuil.")
    ...
    retriever = SBTiRetriever(root_dir=Path(args.root_dir))
    ...
    output_path = output_dir / f"download_all_sbti_{safe_name}_{args.fiscal_year}.json"

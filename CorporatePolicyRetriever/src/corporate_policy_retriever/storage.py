...
from .models import Company, PolicyType, ScoredCandidate
from .utils import compute_sha256, file_size_mb, slugify


class CorporatePolicyStorage:
    """
    Stockage des politiques corporate par type.
    Répertoire : data/dossier_ingestion_0/corporate_policies/<policy_type>/
    """

    def __init__(self, root_dir: str | Path = "data/dossier_ingestion_0") -> None:
        self.root_dir = Path(root_dir)
        self.policies_dir = self.root_dir / "corporate_policies"
        self.registry_dir = self.root_dir / "registry"
        self.registry_path = self.registry_dir / "corporate_policies_registry.jsonl"
        self._ensure_directories()

    def store_candidate_policy(
        self,
        ...
        candidate_dir = (
            self.policies_dir / policy_type.value / company_slug / "candidates"
        )
        ...
        manifest = {
            "document_type": f"corporate_policy_{policy_type.value}",
            ...
            "ingestion": {
                ...
                "storage_version": "corporate_policy_candidate_storage_v0",
            },
        }

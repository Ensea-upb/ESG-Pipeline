...
@dataclass
class ClimateReportRequest:
    """
    Représente la demande documentaire pour un rapport climat.
...
class SearchCandidate:
    ...
    Il peut être :
    - un vrai rapport climat / TCFD / transition ;
    - un rapport annuel contenant une section climat ;
    - une page HTML ;
    - un communiqué ;

...
class ResolvedPDFLinks:
    """
    Résultat de résolution HTML -> liens PDF.
    """
...
class HTMLToPDFLinkResolver:
    ...
    def resolve(
        ...
        """
        Ouvre une page HTML candidate et extrait les liens PDF.
        """
    ...
    def _extract_pdf_candidates(
        ...
        """
        Extrait les liens PDF depuis <a>, <iframe> et <embed>.
        """

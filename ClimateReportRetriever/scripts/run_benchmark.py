...
def print_summary(records: list[dict]) -> None:
    ...
    print("\n" + "=" * 100)
    print("SYNTHÈSE DU BENCHMARK CLIMATE REPORT")
    print("=" * 100)
...
def save_benchmark_report(
    ...
    output_path = (
        registry_dir
        / f"benchmark_climate_report_{fiscal_year}_{timestamp}.json"
    )

    payload = {
        "benchmark_name": "climate_report_retriever_benchmark",
        "fiscal_year": fiscal_year,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Benchmark du moteur ClimateReportRetriever."
    )

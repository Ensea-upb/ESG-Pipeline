...
def print_summary(records, label):
    print(f"\n{'='*90}\nSYNTHESE DU BENCHMARK EARNINGS CALL\n{'='*90}")
...
def main():
    ...
    retriever = EarningsCallRetriever(root_dir=root_dir)
    records = []

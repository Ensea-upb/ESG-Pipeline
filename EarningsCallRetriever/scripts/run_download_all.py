...
from src.earnings_call_retriever.models import Company
from src.earnings_call_retriever.retriever import EarningsCallRetriever
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Télécharger tous les transcripts d'earnings calls dont le score dépasse un seuil.")
    ...
    retriever = EarningsCallRetriever(root_dir=Path(args.root_dir))
    ...
    output_path = output_dir / f"download_all_earnings_call_{safe_name}_{args.fiscal_year}.json"

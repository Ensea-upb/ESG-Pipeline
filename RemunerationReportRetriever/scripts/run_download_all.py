...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Télécharger tous les candidats rapports de rémunération "
    ...
    retriever = RemunerationReportRetriever(root_dir=Path(args.root_dir))
    ...
    print("\n=== Remuneration Report Retriever Result ===")
    ...
    output_path = (
        output_dir
        / f"download_all_remuneration_{safe_company_name}_{args.fiscal_year}.json"
    )

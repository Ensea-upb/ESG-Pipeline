...
class RemunerationReportStorage:
    """
    Stockage des candidats rapports de rémunération des dirigeants.
    """

    def __init__(self, root_dir: str | Path = "data/dossier_ingestion_0") -> None:
        self.root_dir = Path(root_dir)
        self.remuneration_reports_dir = self.root_dir / "remuneration_reports"
        self.registry_dir = self.root_dir / "registry"
        self.registry_path = self.registry_dir / "remuneration_reports_registry.jsonl"
        self._ensure_directories()

    def store_candidate_remuneration_report(
        self,
        ...
        """
        Stocke dans :
        data/dossier_ingestion_0/remuneration_reports/<entreprise>/<année>/candidates/
        """
        ...
        candidate_dir = (
            self.remuneration_reports_dir / company_slug / str(fiscal_year) / "candidates"
        )
        ...
        manifest = {
            "document_type": "remuneration_report_candidate",
            ...
            "ingestion": {
                ...
                "storage_version": "remuneration_report_candidate_storage_v0",
            },
        }
    ...
    def _ensure_directories(self) -> None:
        self.remuneration_reports_dir.mkdir(parents=True, exist_ok=True)
        self.registry_dir.mkdir(parents=True, exist_ok=True)

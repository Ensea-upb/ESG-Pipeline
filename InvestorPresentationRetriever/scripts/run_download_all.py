...
from src.investor_presentation_retriever.models import Company
from src.investor_presentation_retriever.retriever import InvestorPresentationRetriever
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Télécharger toutes les présentations investisseurs dont le score dépasse un seuil.")
    ...
    retriever = InvestorPresentationRetriever(root_dir=Path(args.root_dir))
    ...
    print("\n=== InvestorPresentationRetriever Result ===")
    ...
    output_path = output_dir / f"download_all_investor_presentation_{safe_name}_{args.fiscal_year}.json"

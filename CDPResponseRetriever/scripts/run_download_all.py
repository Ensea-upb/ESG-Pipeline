...
from src.cdp_response_retriever.models import Company
from src.cdp_response_retriever.retriever import CDPResponseRetriever
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Télécharger toutes les réponses CDP dont le score dépasse un seuil.")
    ...
    retriever = CDPResponseRetriever(root_dir=Path(args.root_dir))
    ...
    output_path = output_dir / f"download_all_cdp_response_{safe_name}_{args.fiscal_year}.json"

...
def print_summary(records, label):
    print(f"\n{'='*90}\nSYNTHESE DU BENCHMARK CDP RESPONSE\n{'='*90}")
...
def main():
    ...
    retriever = CDPResponseRetriever(root_dir=root_dir)
    records = []

...
class SustainabilityReportStorage:
    """
    Stockage des candidats Sustainability / ESG / RSE.
    ...
    def __init__(self, root_dir: str | Path = "data/dossier_ingestion_0") -> None:
        ...
        self.sustainability_reports_dir = self.root_dir / "sustainability_reports"
        self.registry_dir = self.root_dir / "registry"
        self.registry_path = self.registry_dir / "sustainability_reports_registry.jsonl"

        self._ensure_directories()

    def store_candidate_sustainability_report(
        self,
        ...
        """
        Stocke un candidat rapport ESG / Sustainability / RSE.

        Le fichier est placé dans :

        data/dossier_ingestion_0/sustainability_reports/<entreprise>/<année>/candidates/
        """
        ...
        candidate_dir = (
            self.sustainability_reports_dir
            / company_slug
            / str(fiscal_year)
            / "candidates"
        )
        ...
        manifest = {
            "document_type": "sustainability_report_candidate",
            ...
            "ingestion": {
                ...
                "storage_version": "sustainability_report_candidate_storage_v0",
            },
        }
    ...
    def _ensure_directories(self) -> None:
        ...
        self.sustainability_reports_dir.mkdir(parents=True, exist_ok=True)
        self.registry_dir.mkdir(parents=True, exist_ok=True)

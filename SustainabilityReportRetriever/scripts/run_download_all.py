...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Télécharger tous les candidats ESG / Sustainability / RSE dont le score dépasse un seuil."
    )
    ...
    parser.add_argument(
        "--official-domain",
        default=None,
        help="Domaine officiel. Exemple : lvmh.com",
    )

    parser.add_argument(
        "--ticker",
        default=None,
        help="Ticker. Exemple : MC",
    )

    parser.add_argument(
        "--isin",
        default=None,
        help="ISIN. Exemple : FR0000121014",
    )
    ...
    print("\n=== Sustainability Report Retriever Result ===")
    ...
    output_path = (
        output_dir
        / f"download_all_sustainability_{safe_company_name}_{args.fiscal_year}.json"
    )

...
@dataclass
class GovernanceReportRequest:
    """
    Représente la demande documentaire pour un rapport de gouvernance.

    Ici, l'année peut désigner soit :
    - l'année de publication ;
    - soit l'exercice couvert.

    Pour l'instant, on garde fiscal_year par cohérence avec les autres moteurs.
    """
...
class SearchCandidate:
    ...
    Il peut être :
    - un vrai rapport de gouvernance ;
    - un rapport annuel contenant une section gouvernance ;
    - une page HTML ;
    - un avis de convocation (à rejeter) ;

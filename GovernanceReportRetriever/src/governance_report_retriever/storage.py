...
class GovernanceReportStorage:
    """
    Stockage des candidats rapports de gouvernance d'entreprise.
    ...
    def __init__(self, root_dir: str | Path = "data/dossier_ingestion_0") -> None:
        ...
        self.governance_reports_dir = self.root_dir / "governance_reports"
        self.registry_dir = self.root_dir / "registry"
        self.registry_path = self.registry_dir / "governance_reports_registry.jsonl"

        self._ensure_directories()

    def store_candidate_governance_report(
        self,
        ...
        """
        Stocke un candidat rapport de gouvernance.
        ...
        manifest = {
            "document_type": "governance_report_candidate",
            ...
            "ingestion": {
                ...
                "storage_version": "governance_report_candidate_storage_v0",
            },
        }
    ...
    def _ensure_directories(self) -> None:
        self.governance_reports_dir.mkdir(parents=True, exist_ok=True)
        self.registry_dir.mkdir(parents=True, exist_ok=True)

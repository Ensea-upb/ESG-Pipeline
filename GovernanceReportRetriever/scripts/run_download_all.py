...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Télécharger tous les candidats rapports de gouvernance "
    ...
    retriever = GovernanceReportRetriever(root_dir=Path(args.root_dir))
    ...
    print("\n=== Governance Report Retriever Result ===")
    ...
    output_path = (
        output_dir
        / f"download_all_governance_{safe_company_name}_{args.fiscal_year}.json"
    )

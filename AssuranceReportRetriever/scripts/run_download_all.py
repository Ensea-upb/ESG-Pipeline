...
from src.assurance_report_retriever.models import Company
from src.assurance_report_retriever.retriever import AssuranceReportRetriever
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Télécharger tous les rapports d'assurance ESG dont le score dépasse un seuil.")
    ...
    retriever = AssuranceReportRetriever(root_dir=Path(args.root_dir))
    ...
    print("\n=== AssuranceReportRetriever Result ===")
    ...
    output_path = output_dir / f"download_all_assurance_report_{safe_name}_{args.fiscal_year}.json"

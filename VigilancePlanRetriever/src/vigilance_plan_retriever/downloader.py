...
class PDFDownloader:
    """
    Téléchargeur PDF robuste avec session persistante, multiple profils de headers
    et retry sur 429/5xx/timeout.
    """
                        ...
                        if 200 <= response.status_code <= 299:
                            ...
                            attempted_strategies.append(
                                PDFDownloadAttempt(
                                    ...
                                    strategy=strategy_name,
                                    status="not_a_pdf",
                                    message="Réponse HTTP 2xx, mais contenu non PDF.",
                                    http_status_code=response.status_code,
                                    content_type=content_type,
                                )
                            )
    ...
    def _final_message(status: str) -> str:
        messages = {
            ...
            "blocked_or_forbidden": "Le serveur bloque certaines stratégies de téléchargement.",

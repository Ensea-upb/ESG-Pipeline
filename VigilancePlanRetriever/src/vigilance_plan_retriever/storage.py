...
class VigilancePlanStorage:
    """
    Stockage des candidats plans de vigilance / devoir de vigilance.
    """

    def __init__(self, root_dir: str | Path = "data/dossier_ingestion_0") -> None:
        self.root_dir = Path(root_dir)
        self.vigilance_plans_dir = self.root_dir / "vigilance_plans"
        self.registry_dir = self.root_dir / "registry"
        self.registry_path = self.registry_dir / "vigilance_plans_registry.jsonl"
        self._ensure_directories()

    def store_candidate_vigilance_plan(
        self,
        ...
        """
        Stocke dans :
        data/dossier_ingestion_0/vigilance_plans/<entreprise>/<année>/candidates/
        """
        ...
        candidate_dir = (
            self.vigilance_plans_dir / company_slug / str(fiscal_year) / "candidates"
        )
        ...
        manifest = {
            "document_type": "vigilance_plan_candidate",
            ...
            "ingestion": {
                ...
                "storage_version": "vigilance_plan_candidate_storage_v0",
            },
        }
    ...
    def _ensure_directories(self) -> None:
        self.vigilance_plans_dir.mkdir(parents=True, exist_ok=True)
        self.registry_dir.mkdir(parents=True, exist_ok=True)

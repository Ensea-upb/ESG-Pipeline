...
def main() -> None:
    parser = argparse.ArgumentParser(description="Télécharger tous les rapports semestriels dont le score dépasse un seuil.")
    ...
    retriever = HalfYearReportRetriever(root_dir=Path(args.root_dir))
    ...
    print("\n=== HalfYearReportRetriever Result ===")
    ...
    output_path = output_dir / f"download_all_half_year_{safe_name}_{args.fiscal_year}.json"
